...
export const Graph = () => {
  ...
  return (
    <div ref={ref} className="relative ">
      <button
        className="absolute cursor-pointer z-10 left-full group"
        onClick={() => setIsOpen(false)}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="absolute -translate-x-full -translate-y-full opacity-0 group-hover:opacity-100 duration-200"
          width="44"
          height="44"
          viewBox="0 0 24 24"
          stroke-width="1.5"
        ...
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="absolute -translate-x-full -translate-y-full group-hover:opacity-0 duration-200"
          width="44"
          height="44"
          viewBox="0 0 24 24"
          stroke-width="1.5"
      ...
      <div className={"flex align-middle"}>
        <p className="">Mostrar precios BTC </p>{" "}
        <button
